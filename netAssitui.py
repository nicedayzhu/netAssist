...
class Ui_NetAssist(object):
    def setupUi(self, NetAssist):
        ...
        self.Sendfile = QtWidgets.QCheckBox(self.SendSettings)
        self.Sendfile.setObjectName("Sendfile")
        self.gridLayout.addWidget(self.Sendfile, 0, 0, 1, 1)
        ...
        self.load_btn = QtWidgets.QPushButton(self.SendSettings)
        self.load_btn.setObjectName("load_btn")
        self.gridLayout.addWidget(self.load_btn, 5, 0, 1, 1)
    ...
    def retranslateUi(self, NetAssist):
        ...
        self.prot_box.setItemText(2, _translate("NetAssist", "UDP Server"))
        self.prot_box.setItemText(3, _translate("NetAssist", "UDP Client"))
        ...
        self.Sendfile.setText(_translate("NetAssist", "发送文件"))
        ...
        self.load_btn.setText(_translate("NetAssist", "文件载入"))
